...
import { Mail, Lock, LogIn, Github, User } from 'lucide-react';
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', marginTop: '0.75rem' }}>
            Access your secure customer dashboard
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input type="email" placeholder="john@example.com" style={{ paddingLeft: '52px', borderRadius: '16px', height: '56px', width: '100%', border: '1.5px solid #e5e7eb', textAlign: 'left' }} value={email} onChange={(e) => setEmail(e.target.value)} required />
            </div>
          </div>
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input type="password" placeholder="••••••••" style={{ paddingLeft: '52px', borderRadius: '16px', height: '56px', width: '100%', border: '1.5px solid #e5e7eb', textAlign: 'left' }} value={password} onChange={(e) => setPassword(e.target.value)} required />
            </div>
          </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '2.5rem', color: 'var(--text-light)', fontWeight: 500 }}>
          New to Royal Hotel? <Link to="/register?role=customer" style={{ color: 'var(--primary)', fontWeight: 700, textDecoration: 'none' }}>Create Account</Link>
        </p>
      </motion.div>
    </div>
  );
